...
public class FrameSave extends JFrame {
	 ...
	 */
	public FrameSave(int mode) throws FontFormatException, IOException{
	...
	public void addContent() throws FontFormatException, IOException{
		...
		saveButton.setFont(mainMenuFont);
		...
		JLabel enterFileName = new JLabel("Enter file name...");
		...
		userText.setPreferredSize(new Dimension(240, 50));
		userText.setFont(settingMainText);
		...
		saveButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					if (mode == 1) {
						XMLSaveEdit save = new XMLSaveEdit(userText.getText(), GameEngineData.getWindowSize());
					} else {
						XMLSaveGame save = new XMLSaveGame(userText.getText(), GameEngineData.getWindowSize());
					}
